  ...
  <section className="bg-gray-50">
    <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
      <div className="flex justify-between items-baseline">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900">Свой склад техники</h2>
        <Link href="/products" className="hidden text-sm font-semibold text-accent sm:block">
