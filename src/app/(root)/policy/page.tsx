      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div>
          ...
          <p className='mt-10'>
            ...
            которую сайт{" "}
            <strong>Интернет магазин &quot;Холод в дом&quot;</strong>, (далее –
            Сайт) расположенный на доменном имени <strong>mysite.ru</strong> (а
            также его субдоменах), может получить о Пользователе во время
            использования сайта mysite.ru (а также его субдоменов), его программ
            и его продуктов.
          </p>
          ...
          <strong className='font-normal'>
            <p>
              ...
              <strong>Интернет магазин &quot;Холод в дом&quot;</strong>,
              действующие от имени ИП Иванов С.С, которые организуют и (или)
              осуществляют обработку персональных данных, а также определяет
            ...
            <p>
              1.1.5. «Сайт{" "}
              <strong> Интернет магазин &quot;Холод в дом&quot;</strong>» - это
              совокупность связанных между собой веб-страниц, размещенных в сети
              Интернет по уникальному адресу (URL): <strong>mysite.ru</strong>,
            ...
            <p>
              ...
              Интернет магазин &quot;Холод в дом&quot;, а также другие временные
              страницы, внизу который указана контактная информация
              Администрации
            </p>

            <p>
              1.1.5. «Пользователь сайта{" "}
              <strong>Интернет магазин &quot;Холод в дом&quot;</strong> » (далее
            ...
            <p>
              2.1. Использование сайта Интернет магазин &quot;Холод в дом&quot;
            ...
            <p>
              ...
              Пользователь должен прекратить использование сайта Интернет
              магазин &quot;Холод в дом&quot; .
            </p>

            <p>
              2.3. Настоящая Политика конфиденциальности применяется к сайту
              Интернет магазин &quot;Холод в дом&quot;. Сайт не контролирует и
              не несет ответственность за сайты третьих лиц, на которые
              Пользователь может перейти по ссылкам, доступным на сайте Интернет
              магазин &quot;Холод в дом&quot;.
            </p>
            ...
            <p>
              ...
              регистрации на сайте Интернет магазин &quot;Холод в дом&quot;, при
            ...
            <p>
              ...
              Пользователем путём заполнения форм на сайте Интернет магазин
              &quot;Холод в дом&quot; и включают в себя следующую информацию:
              <br />
            ...
            <p>
              ...
              Интернет магазин &quot;Холод в дом&quot;, если Пользователь дал
            ...
            <p>
              ...
              выполнения заказа Пользователя, оформленного на сайте Интернет
              магазин &quot;Холод в дом&quot;, включая доставку Товара,
            ...
            <p>
              ...
              персональных данных, необходимых для использования сайта Интернет
              магазин &quot;Холод в дом&quot;, и давать согласие на их
              обработку.
            </p>
            ...
            <p>
              ...
              Интернет магазин &quot;Холод в дом&quot;. <br />
            ...
            <p>
              ...
              находящихся в свободном публичном доступе на сайте Интернет
              магазин &quot;Холод в дом&quot;) допускается их распространение
            ...
            <p>
              ...
              и иных коммуникационных данных, содержащихся на сайте Интернет
              магазин &quot;Холод в дом&quot; или передаваемых через него.
            </p>
            ...
            <p>
              ...
              информацию, размещенную пользователем на сайте Интернет магазин
              &quot;Холод в дом&quot;, включая, но не ограничиваясь: информацию,
            ...
            <p>
              ...
              ее размещения на сайте Интернет магазин &quot;Холод в дом&quot;,
            ...
            <p>
              ...
              конфиденциальности следует сообщать по адресу: mysite@mail.ru
            </p>

            <p>
              9.4. Действующая Политика конфиденциальности размещена на странице
              по адресу http://mysite.ru/politika.html
            </p>

            <p>Обновлено: 02 Февраля 2024 года</p>
            <p>г. Саранск, ИП Иванов С.С</p>
          </strong>
        </div>
      </div>
    </div>
